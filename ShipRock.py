...
"""
print ("First we need to check the weather. Is the weather good today?")
random_weather = randint(1,2)
if random_weather == 1:
    print ("Weather is good, we can climb!")
    climber1 = Climber("Erich Purpur", 13.0)
    climber1.engine()
elif random_weather == 2:
    print ("Weather is not good. Try again tomorrow.")
    sys.exit()
"""
climber1 = Climber("Erich Purpur", 13.0)
climber1.engine()
#ShipRock2.climber2 = Climber("Jay Tilley", 12.0)
#ShipRock2.climber2.engine()
